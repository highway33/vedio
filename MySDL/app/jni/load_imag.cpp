...
bool loadMedia()
{
	...
	if( !gPortraitTexture.loadFromFile( "/storage/emulated/0/FaceRecogcallbackStd.jpg" ) )
	{
		SDL_Log( "Failed to load portrait texture!\n" );
		success = false;
	}
	if( !gLandscapeTexture.loadFromFile( "/storage/emulated/0/FaceRecogcallbackStd.jpg" ) )
	{
